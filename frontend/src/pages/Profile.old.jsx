          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <div className="flex items-center justify-between sm:justify-end gap-2 pt-4 sm:pt-0 border-t sm:border-t-0 border-white/5">
              <span className={`inline-flex items-center px-3 py-1 rounded-full text-[10px] sm:text-xs font-medium capitalize ${
                currentPlan === 'pro' ? 'bg-blue-500/20 text-blue-300 border border-blue-500/20' :
      ...
      <Card>
        ...
        <CardBody>
          ...
          <div className={`p-5 rounded-xl bg-gradient-to-br ${
            currentPlan === 'pro' ? 'from-blue-500/20 to-cyan-500/20 border border-blue-500/30' :
            currentPlan === 'business' ? 'from-amber-500/20 to-orange-500/20 border border-amber-500/30' :
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <Crown className={`w-12 h-12 ${
                ...
                currentPlan === 'business' ? 'text-amber-400' :
                'text-white/20'
              }`} />
            </div>
